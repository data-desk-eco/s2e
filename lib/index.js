...
// Whole-AOI pipeline (search → concurrent detect → cluster) for the CLI and API.
export { runAOI } from './run.js';
...
// Projection + bbox helpers.
export { wgs84ToUtm, utmToWgs84, utmParams, geomBbox, padBbox, bboxAreaKm2 } from './geo.js';
