...
export function detectBlock(b12Raw, b11Raw, b8aRaw, sclRaw, meta) {
    const { date, epsg, imgMinX, imgMaxY, resX, resY,
            ...
            sunElevation = null, sunAzimuth = null } = meta;
    ...
    for (let labelId = 1; labelId <= count; labelId++) {
        ...
        detections.push({
            ...
            lat,
            max_b12: peakB12,
            // B11 reflectance at the same pixel as the peak B12. Real flares are thermal
            // sources whose B12 (2200nm) radiance >> B11 (1600nm) radiance, so peak_b12
            // significantly exceeds peak_b11. Sun glint reflects sunlight where the
            // spectral irradiance ratio is closer to 1.
            peak_b11: b11[peakIdx],
            avg_b12: avgB12,
            pixels: nPixels,
            date,
